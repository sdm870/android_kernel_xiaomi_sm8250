			  ...
			  struct power_supply *chg_psy)
{
	...
	int vchrg, chg_type, chg_status, ioerr;
	 ...
	 /* TODO: We can do this better for now this will do!
	 */
	bms_psy = power_supply_get_by_name("sm8150_bms");
	...
	chg_status = GPSY_GET_INT_PROP(bms_psy, POWER_SUPPLY_PROP_STATUS,
						&ioerr);
